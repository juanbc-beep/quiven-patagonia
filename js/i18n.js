...
window.I18N = (function () {
  ...
  var dict = {
    ...
    galeriaDesc1: { en: 'Patagonian prawn over roasted beetroot, with a citrus note and a crisp texture.' },
    galeriaDesc2: { en: 'A bite of free-range chicken, roasted squash and seasonal herbs.' },
    galeriaDesc3: { en: 'Squash velouté with southern king crab and a black olive tuile.' },
    galeriaDesc4: { en: 'Braised pork belly, crisp Andean potato and a touch of beetroot.' },
    galeriaDesc5: { en: 'Smoked eggplant over squash cream, with edible flowers from the garden.' },
    galeriaDesc6: { en: 'Patagonian cut in black pepper crust, with Andean potato and forest mushrooms.' },
    galeriaDesc7: { en: 'House-cured trout, over a corn scone with cream cheese.' },
    galeriaDesc8: { en: 'Nahuel Huapi trout with a wild red berry sauce.' },
    galeriaDesc9: { en: 'Grilled stuffed matambrito, asparagus and squash purée.' },
    galeriaDesc10: { en: 'Trout smoked tableside, with herbs and seasonal flowers.' },
    galeriaDesc11: { en: 'Regional chocolate, fresh strawberry and crisp meringue.' },
    galeriaDesc12: { en: 'Glazed green apple over a Patagonian hazelnut crumble.' },
    galeriaDesc13: { en: 'Chocolate bonbons with cassis, a lavender sphere and edible flower.' },
    galeriaDesc14: { en: 'Glazed cherries, meringues and cream, for a sweet close.' },
